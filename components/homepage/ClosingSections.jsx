...
export function FinalCTA() {
  return <section className={s.finalSection}><div className={`${s.wrap} ${s.finalGrid}`}><div><Eyebrow>Connect customers to what matters.</Eyebrow><h2>The next step<br />starts with a tap.</h2><a href="#options" className={s.lightButton}>Choose your TapRank <Arrow /></a><TrustLine /></div><div className={s.finalStands}><Stand src={assets.instagram} alt="Instagram TapRank stand" /><Stand alt="Google Review TapRank stand" /><Stand src={assets.tripadvisor} alt="Tripadvisor TapRank stand" /></div></div></section>;
}
