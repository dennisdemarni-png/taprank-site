...
export default function Homepage() {
  ...
  return <div className={s.home} id="top"><a className={s.skipLink} href="#main">Skip to content</a><div className={s.announcement}>Free UK delivery <span>·</span> Ready to use <span>·</span> No subscription</div>
    ...
    <main id="main"><Hero /><TapDemo /><ActionShowcase /><CustomerProof /><VariantSelector selected={selected} onSelect={selectVariant} /><CustomShowcase onSelect={selectVariant} /><Ordering /><TrustStrip /><FAQ /><FinalCTA /></main>
