...
export default function TapDemo() {
  ...
  return <section className={s.demoSection} id="how-it-works" aria-labelledby="demo-title"><div className={s.wrap}>
    ...
    <div className={s.demoGrid}><div className={s.demoVisual} data-step={step}><span className={s.demoOrbit} aria-hidden="true" /><div className={s.demoStand}><Stand /></div><div className={s.demoPhone}><Phone /><span className={s.phoneOpenLabel}>Your hosted business page</span></div><span className={s.nfcSignal} aria-hidden="true">)))</span><div className={s.demoResult} aria-hidden="true"><span>TapRank page opened</span><strong>Review · Follow · Book <Arrow /></strong></div></div>
