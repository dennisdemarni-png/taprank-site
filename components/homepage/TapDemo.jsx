...
export default function TapDemo({ googleDesign }) {
  ...
  return <section className={s.demoSection} id="how-it-works" aria-labelledby="demo-title"><div className={s.wrap}>
    ...
    <div className={s.videoRow}><div><strong>See a real tap in action.</strong><p>See how TapRank connects your stand to your business page.</p></div><button className={s.outlineButton} type="button" aria-expanded={showVideo} aria-controls="taprank-video" onClick={() => setShowVideo(!showVideo)}>{showVideo ? "Close video" : "▶ Watch the demo"}</button></div>
