...
export const taprankPages = validateTapRankPages({
  "barber-demo": {
    ...
    actions: [
      { label: "Visit Our Website", icon: "website", href: "https://example.com/" },
      { label: "Booking Enquiry", icon: "booking", href: "mailto:fade-club@example.com" },
      { label: "Call Us", icon: "call", href: "tel:+441632960001" },
      { label: "Get Directions", icon: "map", href: "https://www.google.com/maps/search/?api=1&query=Northern+Quarter%2C+Manchester" },
    ],
    openingHours: [
  ...
  "restaurant-demo": {
    ...
    actions: [
      { label: "View Menu", icon: "menu", href: "https://example.com/" },
      { label: "Booking Enquiry", icon: "booking", href: "mailto:ember-and-vine@example.com" },
      { label: "Call Us", icon: "call", href: "tel:+441632960002" },
      { label: "Get Directions", icon: "map", href: "https://www.google.com/maps/search/?api=1&query=Spinningfields%2C+Manchester" },
    ],
    openingHours: [
  ...
  "salon-demo": {
    ...
    actions: [
      ...
      { label: "Call Us", icon: "call", href: "tel:+441632960003" },
      { label: "Get Directions", icon: "map", href: "https://www.google.com/maps/search/?api=1&query=Ancoats%2C+Manchester" },
    ],
    openingHours: [
