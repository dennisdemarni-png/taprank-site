...
export default function Hero({ googleDesign, onDesignSelect }) {
  return <>
    <section className={`${s.wrap} ${s.hero}`} aria-labelledby="hero-title" id="hero">
      ...
      <div className={s.heroVisual}>
        <div className={s.heroDisc} aria-hidden="true" /><div className={s.heroStand}><Stand priority src={googleDesign.image} alt={`Google Review ${googleDesign.name} TapRank stand`} /></div>
      ...
      <GoogleDesignSelector hero selected={googleDesign} onSelect={onDesignSelect} />
